...
#   depends_on = [null_resource.ocp_installer, null_resource.ocp_client]

#   provisioner "local-exec" {
#     command     = "./openshift-install create cluster --dir=./installer_files --log-level=info --ssh-public-key=${var.ssh_public_key_path}"
#     working_dir = "installer_files/"
#   }
# }

# resource "null_resource" "get_console_info" {
#   depends_on = [null_resource.install_openshift]

#   provisioner "local-exec" {
#     command     = "./openshift-install wait-for install-complete --dir=./installer_files && ./openshift-install console --dir=./installer_files"
#     working_dir = "installer_files/"
#   }
# }